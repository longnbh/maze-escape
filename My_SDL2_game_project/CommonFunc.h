...
const int GAME_OVER_X = 175, GAME_OVER_Y = 180, GAME_OVER_WIDTH = 250, GAME_OVER_HEIGHT = 197;
...
public:
	...
	void HandleEvents();
	bool ShowMenu(SDL_Renderer* renderer, highScore& hs, Sound& sound);
	...
	void handleEndTime(SDL_Renderer* renderer, highScore& hs, int score, Sound& endSound);
